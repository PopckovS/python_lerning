...
Декораторы могут оборачивать друг друга, вызывая один над другим,
тогда они будут записаны следующим образом:

@bread
@tomamto
def meat(food='ветчина'):
    print(food)

С начала отработает декоратор @brad - который обернет все надписями хлеба.
Потом оборачивает в нутри хлеба надписями помидоров.
И только в конце, в середине, будет надпись ветчина
'''

# ======================== Первый пример декораторов =====================
